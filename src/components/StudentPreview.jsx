...
<div style={{width:400,height:400,borderWidth:1,borderColor:'white',marginTop:20,borderRadius:10,boxShadow:'3px 3px 9px black',
}}>
...
<div style={{height:'wrap-content',width:400,borderWidth:1,borderColor:'white',marginTop:20,borderRadius:10,
marginLeft:50,scrollBehavior:'smooth',boxShadow:'3px 3px 9px black'}}>
