...
const EndUser = () => {
    return (
        ...
        <h4>Last updated March 26, 2023</h4>

<p>Tiyake (ጥያቄ) is licensed to You (End-User) by Lik Systems Solutions PLC, located and registered at Addis Ababa, Addis Ababa, Addis Ababa, Bole 00000, Ethiopia ("Licensor"), for use only under the terms of this License Agreement.</p>
...
<p>The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. Lik Systems Solutions PLC, not the Services, is solely responsible for the Licensed Application and the content thereof.</p>

<p>This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Apple Media Services Terms and Conditions and Google Play Terms of Service ("Usage Rules"). Lik Systems Solutions PLC acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.</p>

<p>Tiyake (ጥያቄ) when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Tiyake (ጥያቄ) is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS") or Google's operating system ("Android").</p>

<h4>TABLE OF CONTENTS</h4>

<ol type="1">
  <li>1. THE APPLICATION</li>
  <li> 2. SCOPE OF LICENSE</li>
...
<p>Tiyake (ጥያቄ) ("Licensed Application") is a piece of software created to facilitate students with the right tools to tackle any of their national examinations — and customized for iOS and Android mobile devices ("Devices"). It is used to access previous national examinations with their correct answer and explanation, do questions related to single subject, topic, or even sub topic, collaborate with other students, ask qualified professional teachers what their take is on questions, get analysis of exam questions and answers regarding, topics and sub-topics.</p>
...
<p>2.3  You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with Lik Systems Solutions PLC's prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application.</p>

<p>
2.4  You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with Lik Systems Solutions PLC's prior written consent).
</p>
...
<p>
3.1  The Licensed Application requires a firmware version 2.0.0 or higher. Licensor recommends using the latest version of the firmware.
</p>
...
<p>
4.2  Lik Systems Solutions PLC and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.
</p>

<h4>5. USE OF DATA</h4>

<p>
You acknowledge that Licensor will be able to access and adjust Your downloaded Licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy: https://www.tiyake.com/privacy.
</p>
...
<p>
9.2  No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of Lik Systems Solutions PLC's sphere of influence that affect the executability of the Licensed Application.
</p>

<p>
9.3  You are required to inspect the Licensed Application immediately after installing it and notify Lik Systems Solutions PLC about issues discovered without delay by email provided in Contact Information. The defect report will be taken into consideration and further investigated if it has been emailed within a period of thirty (30) days after discovery.
</p>

<p>
9.4  If we confirm that the Licensed Application is defective, Lik Systems Solutions PLC reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
</p>
...
<p>
Lik Systems Solutions PLC and the End-User acknowledge that Lik Systems Solutions PLC, and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User’s possession and/or use of that Licensed Application, including, but not limited to:
</p>
...
<p>Henock Urgessa <br />
Addis Ababa <br />
Addis Ababa, Addis Ababa, Bole 00000 <br />
Ethiopia <br />
hencok@tiyake.com <br />
</p>

<h4>13. TERMINATION</h4>

<p>The license is valid until terminated by Lik Systems Solutions PLC or by You. Your rights under this license will terminate automatically and without notice from Lik Systems Solutions PLC if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.</p>

<h4>14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</h4>

<p>
Lik Systems Solutions PLC represents and warrants that Lik Systems Solutions PLC will comply with applicable third-party terms of agreement when using Licensed Application.
</p>
...
<p>
Lik Systems Solutions PLC and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, Lik Systems Solutions PLC, and not the Services, will be solely responsible for the investigation, defense, settlement, and discharge or any such intellectual property infringement claims.
</p>

<h4>16. APPLICABLE LAW</h4>

<p>This License Agreement is governed by the laws of Ethiopia excluding its conflicts of law rules.</p>
