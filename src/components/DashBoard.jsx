...
<button onClick={()=>{setShowProfile(true); setShowExam(false);setShowLeaderboard(false); setShowTeacherProfile(false)}} style={{marginTop:5
...
<Button onClick={()=>{setShowExam(true); setShowProfile(false); setShowLeaderboard(false); setShowTeacherProfile(false);setShowFilter(false)}} style={{color:'white'}}> Take Exam
<img src={examImg} alt="" height={30} width={30} style={{marginLeft:5}}/> </Button>
</div>
<div style={{display:"flex",flexDirection:'row',marginBottom:20}}>
<Button style={{color:'white'}} onClick={()=>{setShowExam(false); setShowProfile(false); setShowLeaderboard(false); setShowTeacherProfile(false);setShowFilter(true)}}> Teachers
<img src={teacherImg} alt="" height={30} width={30} style={{marginLeft:5,marginBottom:10}}/> </Button>
</div>
<div style={{display:"flex",flexDirection:'row',marginBottom:20}}>
<Button style={{color:'white'}} onClick={()=>{setShowExam(false); setShowProfile(false); setShowLeaderboard(true); setShowTeacherProfile(false);setShowFilter(false)}}> Leader Board
